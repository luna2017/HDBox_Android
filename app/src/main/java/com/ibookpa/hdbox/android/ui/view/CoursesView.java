...
/**
 * Created by tc on 6/18/16. 自定义课程表视图
 */
public class CoursesView extends ViewGroup {
     ...
     * TODO TextView 中设置的 居中 属性没有效果,目前的解决办法是使用 paddingTop,来实现类似居中的效果
     */
    ...
    private void drawVerticalDivider(Canvas canvas) {
        for (int i = 0; i <= MAX_DAY; i++) {
            ...
            if (i == 0) {
                ...
                if (i == DateUtil.currentDayOfWeek()) {//对今天高亮显示
